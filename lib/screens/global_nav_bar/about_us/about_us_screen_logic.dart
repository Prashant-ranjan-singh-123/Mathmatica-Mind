...
class AboutUsScreenLogic {
  ...
  static void openLinkedin() async {
    ...
    String dt = AboutUsScreenData().socialLinks[2]![1];
  ...
  static void openGithub() async {
    ...
    String dt = AboutUsScreenData().socialLinks[1]![1];
  ...
  static void openTelegram() async {
    ...
    String dt = AboutUsScreenData().socialLinks[3]![1];
...
// ···
  ...
  static void openWebsite() async {
    String dt = AboutUsScreenData().socialLinks[0]![1];
    Uri url = Uri.parse(dt);
    try {
      await launchUrl(url);
    }catch (e){
