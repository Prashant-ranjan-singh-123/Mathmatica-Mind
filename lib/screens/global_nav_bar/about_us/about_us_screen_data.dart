...
class AboutUsScreenData {
  ...
  void _initializeMaps() {
    socialLinks = {
      0: [appAssets.appImage, 'https://prashant-ranjan-singh-123.github.io/'],
      1: [appAssets.appImage, 'https://github.com/Prashant-ranjan-singh-123'],
      2: [appAssets.appImage, 'https://www.linkedin.com/in/prashant-ranjan-singh-b9b6b9217/'],
      3: [appAssets.appImage, 'https://t.me/Prashantsingh255'],
      4: [appAssets.appImage, 'prashant.singh.12312345@gmail.com']
    };
